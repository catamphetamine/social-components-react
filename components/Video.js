...
import { getVideoUrl } from 'social-components/services'
...
function Video({
	video,
	border,
	showPreview: showPreviewProperty = true,
...
Video.propTypes = {
	...
	seekOnArrowKeys: PropTypes.bool,
	seekOnArrowKeysAtBorders: PropTypes.bool,
	seekStep: PropTypes.number,
	largerSeekStep: PropTypes.number,
	changeVolumeOnArrowKeys: PropTypes.bool,
	changeVolumeStep: PropTypes.number,
